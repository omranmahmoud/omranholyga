...
function App() {
  ...
  // Detect if we are in the mobile web variant (/m prefix) and set a dynamic basename
  const isMobileVariant = typeof window !== 'undefined' && window.location.pathname.startsWith('/m');
  const basename = isMobileVariant ? '/m' : undefined; // undefined lets React Router treat it as root
  return (
    <StrictMode>
